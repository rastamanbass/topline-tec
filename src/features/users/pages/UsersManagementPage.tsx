...
export default function UsersManagementPage() {
    ...
    const handleCreateUser = async (data: {
        ...
        try {
            ...
            throw error; // El modal lo manejará
        }
    };
                    ...
                    <div className="p-6">
                        {isLoading ? (
                                    ...
                                    {users.map(user => (
                                        <tr key={user.uid} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <button className="text-primary-600 hover:text-primary-900 mr-3" title="Editar">
                                                    <Edit2 className="w-4 h-4" />
                                                </button>
                                                <button className="text-gray-600 hover:text-gray-900" title={user.isActive !== false ? 'Desactivar' : 'Activar'}>
                            ...
                            <div className="text-center py-12">
                                ...
                                <h3 className="mt-2 text-sm font-medium text-gray-900">No hay usuarios compradores</h3>
