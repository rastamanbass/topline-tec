...
const TOPLINE_WA_NUMBER = import.meta.env.VITE_TOPLINE_WA_NUMBER || '17866593427';
...
function ShipmentTracker({ orderId }: { orderId: string }) {
  ...
  return (
    <div className="mt-3 pt-3 border-t border-gray-100">
          ...
          return (
            <div key={step} className="flex items-center flex-1 min-w-0">
              ...
              {idx < SHIPMENT_STEPS.length - 1 && (
                <div
                  className={`h-0.5 flex-1 mx-0.5 rounded ${done ? 'bg-emerald-400' : 'bg-gray-200'}`}
                />
              )}
            </div>
          );
      ...
      {shipment.notes && <p className="mt-2 text-xs text-gray-500 italic">{shipment.notes}</p>}
    </div>
  );
}
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 flex flex-col items-center gap-3">
            ...
            <p className="text-gray-400 text-sm">
              Explora el catálogo y aparta los equipos que necesitas.
            </p>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span
                      className={`flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full ${cfg.color}`}
                    >
                  ...
                  <div className="flex items-center justify-between border-t border-gray-50 pt-3">
                    ...
                    <div className="flex gap-2 items-center">
                      {order.invoiceId && (
                        <span className="text-xs px-3 py-1.5 bg-emerald-50 text-emerald-700 rounded-lg font-semibold">
