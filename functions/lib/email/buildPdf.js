"use strict";
/**
 * buildPdf.ts — Server-side PDF generation for Cloud Functions.
 * Uses jsPDF node build (dist/jspdf.node.min.js) — no browser/canvas required.
 * Logic mirrors src/services/pdf/generateInvoicePDF.ts exactly.
 */
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.buildPdfBase64 = buildPdfBase64;
...
function buildDoc(invoice) {
    ...
    if (invoice.notes) {
        ...
        const noteLines = doc.splitTextToSize(`Nota: ${invoice.notes}`, contentW - 10);
    ...
    doc.setFontSize(7);
    doc.setTextColor(...GRAY_600);
    doc.text("Este documento no tiene valor fiscal.  ·  TOP LINE TEC  ·  Miami, FL, USA", pageW / 2, footerY, { align: "center" });
    doc.setFontSize(6.5);
...
// ── Public API ──────────────────────────────────────────────────────────────────
/**
 * Returns the invoice PDF as a Base64 string suitable for Resend email attachments.
 */
async function buildPdfBase64(invoice) {
    var _a;
    const doc = buildDoc(invoice);
    const dataUri = doc.output("datauristring");
    return (_a = dataUri.split(",")[1]) !== null && _a !== void 0 ? _a : "";
}
//# sourceMappingURL=buildPdf.js.map